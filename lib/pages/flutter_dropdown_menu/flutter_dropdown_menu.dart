...
// class FlutterDropdownMenu extends StatefulWidget {
//   FlutterDropdownMenu({Key key, this.title}) : super(key: key);

//   final String title;

//   @override
//   _FlutterDropdownMenuState createState() => _FlutterDropdownMenuState();
// }
...
// class _FlutterDropdownMenuState extends State<FlutterDropdownMenu> {
...
class FlutterDropdownMenu extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('FlutterDropdownMenu'),
      ),
      body: Container(
        child: Text('FlutterDropdownMenu'),
      ),
    );
  }
}